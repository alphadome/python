    ...
    def proceed_with_method():
        ...
        for elem in elems:
            if "STATION" in elem.get_attribute("href"):
                station_links_us.append(elem.get_attribute("href"))
        driver.quit()        
        ...
        # select precipitation data
        select_button = driver.find_elements_by_xpath("//input[@name='climate' and @value='becaprcp']")[0]
        select_button.click()
        ...
        for elem in elems:
            if "STATION" in elem.get_attribute("href"):
                station_links_eu.append(elem.get_attribute("href"))
        driver.quit()    
        
        station_links = station_links_us + station_links_eu
        ...
        return str(weather_station_url)
...
def get_weather_data_precip(address, update=''):
    ...
    def proceed_with_method():
        url = get_weather_data_url_precip(address)
...
def get_weather_data_url_temp(address,update=''):
    ...
    def proceed_with_method():
        ...
        # select precipitation data
        select_button = driver.find_elements_by_xpath("//input[@name='climate' and @value='becatemp']")[0]
        select_button.click()
